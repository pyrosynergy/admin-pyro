...
import buildSuperseedsScreen from '../../../../assets/flobites/build-superscreen-screen.webp';
import buildWomenonfloScreen from '../../../../assets/flobites/build-womenonflo-screen.webp';
  ...
  <>
    ...
    <div className="flobites-pyrostack-details">
      ...
      <div className="flobites-pyrostack-detail">
        ...
        <p className="flobites-pyrostack-detail-body">
           We used our proprietary 35+ touchpoint framework, PyroStack<sup>TM</sup>, to map the next steps for growth - starting with storytelling and UI/UX improvements.
        </p>
      </div>
        ...
        <div className="flobites-build-visual">
          <div className="flobites-build-screens">
            <div className="flobites-build-screen">
              <img loading="lazy" decoding="async" src={buildSuperseedsScreen} alt="The Super Seeds Formula ingredient grid screen" />
            </div>
            <div className="flobites-build-screen">
              <img loading="lazy" decoding="async" src={buildWomenonfloScreen} alt="Women on Flo testimonial screen" />
            </div>
          </div>
      ...
      <div className="flobites-pyrostack-detail">
        ...
        {/* <div className="flobites-pyros-visual">
          <div className="flobites-pyros-brand">
            <img loading="lazy" decoding="async" src={pyrosFruitIcon} alt="" className="flobites-pyros-fruit" />
            <span className="flobites-pyros-eat">Eat.</span>
          </div>
          <div className="flobites-pyros-screen">
            <img loading="lazy" decoding="async" src={pyrosNutrientsScreen} alt="Nutrients all in one screenshot showing Iron and Myo-Inositol cards" />
          </div>
        </div> */}
      </div>
    </div>
