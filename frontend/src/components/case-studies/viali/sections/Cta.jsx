...
const Cta = () => (
  <div className="viali-cta">
    <p className="viali-cta-text">
      <span className="viali-cta-text-accent">Want this revamp for your own brand?</span>
    </p>
    <a href="#contact" className="viali-cta-btn">
