...
const DecodeQuestionnaire = () => {
  ...
  const ProgressRow = ({ pct }) => (
    <div className="ds-progress-row">
      <button
        className="ds-nav-icon ds-nav-icon--lg"
        onClick={goBack}
        aria-label="Previous"
      ...
      <button className="ds-nav-icon ds-nav-icon--lg" onClick={doRestart} aria-label="Restart">↺</button>
    </div>
  );

  const NavFooter = ({ fixedDest, disabled = false }) => {
    const dest = fixedDest || pendingNav;
    return (
      <div className="ds-nav-footer">
        <button
          className="ds-nav-footer-next"
          onClick={() => dest && navigate(dest)}
          disabled={disabled || !dest}
        >
          next →
        </button>
      </div>
      ...
      case 'welcome':
        return (
          <div className="ds-card">
            <h1 className="ds-title ds-title--warm">Welcome to the<br />Decode Pipeline</h1>
        ...
        return (
          <div className="ds-card">
            ...
            <div className="ds-grid ds-grid--2col">
              <button className={`ds-option${selectedIdx === 0 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(0, 'exit_prerevenue')}>Pre-revenue</button>
              <button className={`ds-option${selectedIdx === 1 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(1, 'q2')}>Early revenue</button>
              <button className={`ds-option ds-option--wide${selectedIdx === 2 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(2, 'q2')}>Trying to scale</button>
            </div>
          </div>
        );
      ...
      case 'q2':
        return (
          <div className="ds-card">
            ...
            <div className="ds-grid ds-grid--2col">
              <button className={`ds-option${selectedIdx === 0 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(0, 'q3')}>My brand does not reflect what I actually built</button>
              <button className={`ds-option${selectedIdx === 1 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(1, 'q3')}>People do not understand what I do fast enough</button>
              <button className={`ds-option${selectedIdx === 2 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(2, 'q3')}>Growing but the foundation feels shaky</button>
              <button className={`ds-option${selectedIdx === 3 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(3, 'q5')}>I just know something is off</button>
            </div>
          </div>
        );
        ...
        return (
          <div className="ds-card">
            ...
            <div className="ds-grid ds-grid--1col">
              <button className={`ds-option${selectedIdx === 0 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(0, 'q4')}>Yes, and it did not work out</button>
              <button className={`ds-option${selectedIdx === 1 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(1, 'q5')}>Yes, partially, but I hit a wall</button>
              <button className={`ds-option${selectedIdx === 2 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(2, 'q5')}>No, this is my first real attempt</button>
            </div>
          </div>
        );
      ...
      case 'q4':
        return (
          <div className="ds-card">
            ...
            <NavFooter fixedDest="q4b" disabled={q4Sel.length === 0} />
          </div>
        );
      ...
      case 'q4b':
        return (
          <div className="ds-card">
            ...
            <NavFooter fixedDest="q5" disabled={q4bSel.length === 0} />
          </div>
        );
      ...
      case 'q5':
        return (
          <div className="ds-card">
            ...
            <div className="ds-grid ds-grid--1col">
              <button className={`ds-option${selectedIdx === 0 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(0, 'q6')}>Telling my story. Brand, positioning, how I show up.</button>
              <button className={`ds-option${selectedIdx === 1 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(1, 'q6')}>The tech and systems side. Building the right infrastructure.</button>
              <button className={`ds-option${selectedIdx === 2 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(2, 'q6')}>Figuring out what the actual problem even is</button>
              <button className={`ds-option${selectedIdx === 3 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(3, 'q6')}>I know what I need. I just need the right people to build it.</button>
            </div>
          </div>
        );
      ...
      case 'q6':
        return (
          <div className="ds-card">
            ...
            <div className="ds-grid ds-grid--1col">
              <button className={`ds-option${selectedIdx === 0 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(0, 'q7a')}>Me. I am the founder and I decide.</button>
              <button className={`ds-option${selectedIdx === 1 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(1, 'q7a')}>Me, but I want a co-founder or partner aligned first</button>
              <button className={`ds-option${selectedIdx === 2 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(2, 'q7b')}>There are stakeholders or investors involved</button>
            </div>
          </div>
        );
      ...
      case 'q7a':
        return (
          <div className="ds-card">
            ...
            <div className="ds-grid ds-grid--1col">
              <button className={`ds-option${selectedIdx === 0 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(0, 'q8')}>Urgent. I need to move in the next few weeks.</button>
              <button className={`ds-option${selectedIdx === 1 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(1, 'q8')}>Soon. Within the next month or two.</button>
              <button className={`ds-option${selectedIdx === 2 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(2, 'verifying_b')}>Just exploring for now</button>
            </div>
          </div>
        );
      ...
      case 'q7b':
        return (
          <div className="ds-card">
            ...
            <div className="ds-grid ds-grid--1col">
              <button className={`ds-option${selectedIdx === 0 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(0, 'q8')}>Yes. There is a hard deadline coming.</button>
              <button className={`ds-option${selectedIdx === 1 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(1, 'q8')}>No hard date, but I feel the internal urgency</button>
              <button className={`ds-option${selectedIdx === 2 ? ' ds-option--selected' : ''}`} onClick={() => selectOption(2, 'verifying_b')}>No urgency right now. Still exploring.</button>
            </div>
          </div>
        );
      ...
      case 'q8': {
        ...
        return (
          <div className="ds-card">
            ...
            <NavFooter fixedDest="verifying" disabled={!isOk} />
          </div>
        );
      }
...
export default DecodeQuestionnaire;