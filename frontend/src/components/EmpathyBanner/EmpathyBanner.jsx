...
import './EmpathyBanner.css';

const EmpathyBanner = () => (
  <section className="empathy-banner-section">
    <div className="empathy-banner">
      ...
      <p>
        We believe <strong>empathy</strong> is the most underrated ingredient in business. It&apos;s what separates partners who actually get it from agencies who just bill you for it. This is our moat at PyroSynergy: to understand your pressure, your stakes, and your vision before we touch your strategy, which also build foundation for <strong>PyroStack<sup>TM</sup></strong>; our proprietary growth evaluation framework.
